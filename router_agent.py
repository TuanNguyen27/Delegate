...
INSTRUCTIONS = (
    ...
    "When you call slm_help, the tool will return the ENTIRE step-by-step reasoning "
    "and the final answer in \\boxed{}. "
    "You MUST treat that boxed answer as correct and final. "
    "Do not re-decompose the same calculation into smaller parts. "
    "Use the result and move forward.\n\n"
